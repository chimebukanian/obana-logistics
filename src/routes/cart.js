...
*                 $ref: '#/components/schemas/wish_product'
*/
router.post('/add-product', auth.authenticateToken, cartController.addProduct)
...
*                 $ref: '#/components/schemas/wish_product'
*/
router.put('/remove-product', auth.authenticateToken, cartController.removeProduct)
...
*                 $ref: '#/components/schemas/wish_product'
*/
router.get('/list', auth.authenticateToken, cartController.getCart)
router.put('/update', auth.authenticateToken, cartController.updateCart)
